 ...
 public static class TriTriOverlap
 {
    ...
    public static bool TriEdgeIntersect(Vector3 v0, Vector3 v1, Vector3 v2, Vector3 u0, Vector3 u1, out Vector3? intersectionPoint)
    {
        ...
        // put u0,u1 into plane equation 1 to compute signed distances to the plane
        ...
        // // is the edge parallel to the plane and wholely inside the plane?
        // if (Vector3.Dot(n1, u) == 0 && du0du1 == 0)
        // {
        //     return true;
        // }


        return RayIntersectsTriangle(u0, u, v0, v1, v2, out intersectionPoint);

    }


    private static bool RayIntersectsTriangle(Vector3 p, Vector3 d, Vector3 v0, Vector3 v1, Vector3 v2, out Vector3? intersectionPoint)
    {
